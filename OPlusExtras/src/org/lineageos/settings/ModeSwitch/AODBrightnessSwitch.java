...
public class AODBrightnessSwitch implements OnPreferenceChangeListener {

    private static final int NODE = R.string.node_aod_brightness_switch;
    ...
    public static boolean isCurrentlyEnabled(Context context) {
        return FileUtils.getFileValueAsBoolean(getFile(context), false,
            context.getResources().getString(R.string.node_aod_brightness_switch_true),
            context.getResources().getString(R.string.node_aod_brightness_switch_false));
    }
